...
<<<<<<< HEAD
        checksum_string = recieve_data.decode()
=======
        checksum_string = received_data.decode()
>>>>>>> 27b581113388aa3502511fa5b518d8e039aa28e1
    ...
    # If it is not, offset by 1 and check
        ...
        # find every hash in client's list and check to see if server list
        # if hash inside server list, remove from server list copy
...
<<<<<<< HEAD
        # below: send server info to download file
        # use checksums_file()
            ...
            while True:
               ...
               # If it exists then remove it from the localChecksums
                if chunk_number is not None:
                    #change localchecksums to checksums_file() file
...
>>>>>>> 27b581113388aa3502511fa5b518d8e039aa28e1
    ...
    # if temp_log file under current directry.
    # means the download was interrupted last time,
    # we need to check both OLD file and TEMP_LOG file
        try:
